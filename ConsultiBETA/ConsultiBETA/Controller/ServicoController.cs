...
namespace ConsultiBETA.Controller
{
    class ServicoController:Controller
    {
        ...
        public void Excluir(Servico servico)
        {
            ...
            {
                string sqlQuery = "DELETE FROM servico WHERE _id=" + servico.Id;
        ...
        {
            string sqlQuery = "UPDATE servico SET nome='" + servico.Nome + "',descricao='" + servico.Descricao + "',valor=" + servico.Valor + " WHERE _id=" + servico.Id;
            ExecutarSql(sqlQuery);
        }
        ...
        {
            DataRow servicoRow;
            string sqlQuery = "SELECT * FROM servico WHERE _id=" + id;
            servicoRow = ExecutarSqlRetornoObj(sqlQuery);
            Servico servico = new Servico();
            servico.Id = servicoRow.Field<int>("_id");
